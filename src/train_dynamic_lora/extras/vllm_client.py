...
class VLLMClient:
    ...
    def __init__(
        self, host: str = "0.0.0.0", server_port: int = 30005, group_port: int = 50005, connection_timeout: float = 5.0
    ):
    ...
    def init_communicator(self):
        ...
        # requests.get(f"http://0.0.0.0:30005/get_tensor_parallel_size/")
