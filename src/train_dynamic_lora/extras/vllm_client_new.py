...
if __name__ == "__main__":
    ...
    client = VLLMClient(host='22.4.118.18', server_port=30008, connection_timeout=120)
    client.init_communicator()
    ...
    model = AutoModelForCausalLM.from_pretrained("/cpfs/user/long2short/huggingface_model/huggingface_model/Qwen2.5-Math-7B-Instruct").to("cuda")
    client.update_model_params(model)