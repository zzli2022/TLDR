...
exp_name='sft_baseline_Qwen_7_R1_lora_2_CoT_Valve_MixChain_Z_GSM8K_Data_1_Epoch'
export VLLM_WORKER_MULTIPROC_METHOD=spawn
export HF_ENDPOINT=https://hf-mirror.com
lora_path="/path/to/your/checkpoint//QwQ_7B_R1_lora_2_MixChain_C_GSM8K_1_Epoch04_26_16_52"
merge_path="/path/to/your/merged_checkpoint//"$currentTime
python merge_lora.py --base_model /cpfs/user/long2short/huggingface_model/huggingface_model/DeepSeek-R1-Distill-Qwen-7B --lora_model $lora_path --output_dir $merge_path &&  echo $lora_path > $merge_path/created_file.txt
echo $merge_path
#### gsm8k
