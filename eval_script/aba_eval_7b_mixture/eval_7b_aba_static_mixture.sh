...
exp_name='DeepSeek-R1-Distill-Qwen-14B-aba-mixture'
export HF_ENDPOINT=https://hf-mirror.com
merge_path="/path/to/your/checkpoint/DeepSeek-R1-Distill-Qwen-14B-aba-mixture_3200005_15_20_51"
#### gsm8k
...
# #### minervamath
python  ./skythought/skythought_evals/inference_and_check.py --model $merge_path  --task minervamath --tp 4 --temperatures 0.7 --n 1 --max_tokens 8192 --result-dir ./reason_eval_log/${exp_name}/${currentTime}/minervamath/  # 2>&1 | tee aime24.txt
