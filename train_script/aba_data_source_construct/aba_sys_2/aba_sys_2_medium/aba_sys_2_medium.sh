...
currentTime=`date "+%m_%d_%H_%M"`
exp_name="aba_sys_2_medium"
FORMAT_PROMPT_TYPE="DS"
...
export PROJECT_NAME=r1_7b_new_gsm8k_data
export ETA=4
...
DATA_FILE_INFO_PATH=./data/system_1_2_config/7b_data/cot_domain_aba_7B_sys_2_meidum.json  # 用1.5B的低质量SFT刷的, 建议重新跑
