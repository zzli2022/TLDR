...
DATA_FILE_INFO_PATH=.//Users/long2short/Desktop/TLDR_Repo/SkyThought/data/system_1_2_config/cot_domain_data_info_7b_system_1_vs_1_init.json  # 用1.5B的低质量SFT刷的, 建议重新跑
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7  accelerate launch \
    ...
    --vllm_server_host ${SERVE_NODE_IP} \
