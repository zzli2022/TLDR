...
currentTime=`date "+%m_%d_%H_%M"`
exp_name="r1_14b_tldr"
export OUTPUT_PATH=$OUTPUT_PATH$exp_name$currentTime

export MODEL_DIR=/path/to/your/huggingface_model
export DATA_DIR=/path/to/your/data
export serve_ip="" 

export PROJECT_NAME=r1_32b_new_gsm8k_data_1_vs_1_new_chat_template
export ETA=4
...
SHORTCOT_MODEL_NAME=Qwen2.5-14B-Instruct
DATA_FILE_INFO_PATH=./data/system_1_2_config/cot_domain_data_info_14b_system_1_vs_1_init.json  # 用1.5B的低质量SFT刷的, 建议重新跑
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7   accelerate launch \
    ...
    --use_lora False \
    --wait_max_num 11 \
    --shortcot_model_path /path/to/your/huggingface_model/Qwen2.5-14B-Instruct \
    --ddp_timeout=10800 \
    --lora_rank 4 \
    --lora_alpha 32 \
    --lora_nums 4 \
