...
currentTime=`date "+%m_%d_%H_%M"`
exp_name="new_gsm8k_data_1_vs_1_max_len_32000"
...
export PROJECT_NAME=aba_r1_7b_no_update
export ETA=4
...
DATA_FILE_INFO_PATH=./data/system_1_2_config/7b_data/cot_domain_data_info_old_aime_eval_shortest_longcot_1_init_1.json  # 用1.5B的低质量SFT刷的, 建议重新跑
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7  accelerate launch \
    ...
    --dynamic_update_type "constant" \
    --logging_steps 1 \
    --split_batches True \
    --gradient_checkpointing True \
    --deepspeed ${DS_CONFIG_PATH} \
    --vllm_server_host 22.4.106.183 \
